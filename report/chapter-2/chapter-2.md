...
|------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                              | ![badger-meter.jpg](../../assets/chapter-2/badger-meter.jpg)                                                                                                                                                                                                                                                       | ![optirtc.jpg](../../assets/chapter-2/optirtc.jpg)                                                                                                                                                                                                 | ![itron.jpg](../../assets/chapter-2/itron.jpg)                                                                                                                                                                              | ![qlic.jpg](../../assets/chapter-2/qlic.jpg)                                                                                                                                                                               |
...
A continuación, se presentan las preguntas para las entrevistas para ambos segmentos objetivos.

### Segmento 1: PYMES (negocios pequeños y medianos)

Preguntas:
- ¿Cómo controlan actualmente el consumo de agua en su negocio?
- ¿Qué problemas han tenido relacionados con desperdicio o fugas de agua?
...
- **Tecnología:** Dispositivos móviles Apple para gestión
...
- **Tecnología:** Computadoras Mac y laptops para la gestión del negocio, con acceso a sistemas virtuales vía navegador
- ***Navegador Preferido:** Google Chrome

![Entrevista2-Segmento1.png](../../assets/chapter-2/Entrevista2-Segmento1.png)
...
- **Tecnología:** Dell Inspiron
- ***Navegador Preferido:** Edge y Chrome

![Entrevista 1 - segmento2.jpg](../../assets/chapter-2/Entrevista%201%20-%20Segmento2.png)
...
Para los As-Is Scenario, es una herramienta que nos ayuda a ejemplificar de mejor manera cuál es el escenario actual sobre el problema que se intentará resolver.
